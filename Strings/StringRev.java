...
public class StringRev {
    ...
    // this is to finding the vowels in the string from taken to the end user to
    // find the vowels
     ...
     *                   question is the
     *                   write a programming to finding indexOf method values fo a
     *                   given char in all its
    ...
    /**
     *
     * with out using indexOf method to write a programming to remvoe the duplicate
     * chars
